        ...
        <div className="min-h-screen bg-cream text-navy selection:bg-gold selection:text-white">
            <div className="container mx-auto px-4 py-12 md:py-24 max-w-4xl">
                ...
                <header className="mb-16 space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
                    <span className="text-xs uppercase tracking-[0.2em] text-gold font-medium block">La Filosofía</span>
                ...
                <div className="prose prose-lg prose-headings:font-serif prose-p:text-slate-600 prose-p:leading-relaxed max-w-none space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-200">
                    ...
                    <div className="grid md:grid-cols-2 gap-12 text-base md:text-lg">
                        <div className="space-y-6">
                            <p>
                                <strong className="text-navy block mb-2 uppercase tracking-wide text-xs">Accesibilidad</strong>
                            ...
                            <p>
                                <strong className="text-navy block mb-2 uppercase tracking-wide text-xs">Gestión</strong>
                        ...
                        <div className="space-y-6">
                            <p>
                                <strong className="text-navy block mb-2 uppercase tracking-wide text-xs">Eficiencia</strong>
                            ...
                            <p>
                                <strong className="text-navy block mb-2 uppercase tracking-wide text-xs">Optimización</strong>
                    ...
                    <div className="mt-16 pt-8 border-t border-navy/10 flex justify-center">
                        <div className="text-center space-y-4">
                            <p className="text-sm uppercase tracking-widest opacity-50">Escrito por ResiDate</p>
